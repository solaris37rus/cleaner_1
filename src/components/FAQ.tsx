...
export default function FAQ() {
  ...
  const faqs = [
    ...
    {
      question: "Почему заявка не отправляется автоматически с сайта?",
      answer: "Сайт размещается на GitHub Pages — это бесплатный статический хостинг без backend-сервера. Поэтому мы сделали надёжный вариант: сайт готовит текст заявки, копирует его, а клиент отправляет его напрямую в Telegram или VK. Так не нужны платные серверы и секретные токены."
    },
    {
      question: "Можно ли добавить дополнительные услуги уже на месте?",
      answer: "Да, если будет позволять время и наличие нужных средств. Но лучше обсудить все пожелания заранее, чтобы мы могли точно спланировать время и подтвердить стоимость."
    }
  ];
